            ...
            <div class="col-md-4 offset-md-4 mail-form">
               ...
               <?php
                  ...
                  if(isset($_POST['send'])){
                     ...
                     $sender = "From: rohan.powell36@gmail.com";
               ...
               <form action="mail.php" method="POST">
                  ...
                  <div class="form-group">
                     ...
                     <input type="textarea" cols="30" rows="5" class="form-control textarea" name="message" placeholder="Compose your message.."></input> 
                  </div>
                  <div class="form-group">
